...
public class MySQL5PlayerSkillListDAO extends PlayerSkillListDAO
{
	...
	{
		final List<PlayerSkillEntry> skillsActive = Lists.newArrayList(player.getSkillList().getAllSkills());
		final List<PlayerSkillEntry> skillsDeleted = Lists.newArrayList(player.getSkillList().getDeletedSkills());
	...
	private void addSkills(Connection con, Player player, List<PlayerSkillEntry> skills)
	{
		...
		final Collection<PlayerSkillEntry> skillsToInsert = Collections2.filter(skills, skillsToInsertPredicate);
	...
	private void updateSkills(Connection con, Player player, List<PlayerSkillEntry> skills)
	{
		...
		final Collection<PlayerSkillEntry> skillsToUpdate = Collections2.filter(skills, skillsToUpdatePredicate);
	...
	private void deleteSkills(Connection con, Player player, List<PlayerSkillEntry> skills)
	{
		...
		final Collection<PlayerSkillEntry> skillsToDelete = Collections2.filter(skills, skillsToDeletePredicate);
