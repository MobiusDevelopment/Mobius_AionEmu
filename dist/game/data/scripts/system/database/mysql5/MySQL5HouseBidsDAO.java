...
public class MySQL5HouseBidsDAO extends HouseBidsDAO
{
	...
	{
		Connection con = null;
		final Set<PlayerHouseBid> results = new HashSet<>();
		try
		{
			...
			while (rset.next())
			{
				...
				final int houseId = rset.getInt("house_id");
				final long bidOffer = rset.getLong("bid");
				final Timestamp time = rset.getTimestamp("bid_time");
