...
public class _3200Price_Of_Goodwill extends QuestHandler
{
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{// Roikinerk.
				switch (env.getDialog())
				{
					...
					case STEP_TO_1:
					{
						final WorldMapInstance newInstance = InstanceService.getNextAvailableInstance(300100000);
	...
	public HandlerResult onItemUseEvent(QuestEnv env, Item item)
	{
		...
		{
			TeleportService2.teleportTo(player, 400010000, 2887.3613f, 994.43134f, 1527.9968f, (byte) 103);
