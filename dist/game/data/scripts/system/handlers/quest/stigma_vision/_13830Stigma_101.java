...
{
	private static final int questId = 13830;
	...
	public void register()
	{
		...
		qe.registerQuestItem(182216118, questId); // 엘리시움 지원품 안내서1.
	...
	public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName)
	{
		...
		if ((qs != null) && (qs.getStatus() == QuestStatus.START))
		{
			...
			if (zoneName == ZoneName.get("EXALTED_PATH_110010000"))
			{
				if (var == 0)
				{
					SystemMailService.getInstance().sendMail("Miriya", player.getName(), "[Stigma Bundle]", "I'am Miriya stigma's master and I expect you at Sanctum. Come join me.", 182216118, 1, 0, LetterType.NORMAL); // 엘리시움 지원품 안내서1.
					return true;
				}
			}
		}
