 ...
 */
public class _29615Dredgion_Dismantling extends QuestHandler
{
	private static final int questId = 29615;
	
	public _29615Dredgion_Dismantling()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(804821).addOnTalkEvent(questId); // DF5 Nineveh.
	}
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		{
			if (targetId == 804821) // DF5 Nineveh.
			{
				switch (dialog)
				{
					case SELECT_REWARD:
