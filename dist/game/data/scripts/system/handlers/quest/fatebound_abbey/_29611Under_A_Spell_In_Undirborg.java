 ...
 */
public class _29611Under_A_Spell_In_Undirborg extends QuestHandler
{
	private static final int questId = 29611;
	
	public _29611Under_A_Spell_In_Undirborg()
	{
		super(questId);
	}
	...
	{
		qe.registerQuestNpc(804664).addOnQuestStart(questId);
		qe.registerQuestNpc(804664).addOnTalkEvent(questId);
