 ...
 */
public class _29648Supporting_Sefrim extends QuestHandler
{
	private static final int questId = 29648;
	
	public _29648Supporting_Sefrim()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(804736).addOnTalkEvent(questId); // DF5 Sefrimnir.
	}
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		{
			if (targetId == 804736) // DF5 Sefrimnir.
			{
				switch (dialog)
				{
					case SELECT_REWARD:
