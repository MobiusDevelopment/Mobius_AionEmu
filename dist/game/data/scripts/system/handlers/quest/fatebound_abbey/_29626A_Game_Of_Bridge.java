 ...
 */
public class _29626A_Game_Of_Bridge extends QuestHandler
{
	private static final int questId = 29626;
	
	public _29626A_Game_Of_Bridge()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(801765).addOnTalkEvent(questId); // IDLDF5_Under_01_Rohellein.
	}
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		if (qs.getStatus() == QuestStatus.START)
		{
			switch (targetId)
			{
				case 801765: // IDLDF5_Under_01_Rohellein.
				{
		...
		{
			if (targetId == 801765) // IDLDF5_Under_01_Rohellein.
			{
				switch (dialog)
				{
					case SELECT_REWARD:
