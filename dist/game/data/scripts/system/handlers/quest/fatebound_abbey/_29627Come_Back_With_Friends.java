 ...
 */
public class _29627Come_Back_With_Friends extends QuestHandler
{
	private static final int questId = 29627;
	
	public _29627Come_Back_With_Friends()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(804866).addOnTalkEvent(questId); // DF5 Primenk.
	}
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		{
			if (targetId == 804866) // DF5 Primenk.
			{
				switch (dialog)
				{
					case SELECT_REWARD:
