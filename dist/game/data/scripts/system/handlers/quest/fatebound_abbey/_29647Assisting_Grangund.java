...
public class _29647Assisting_Grangund extends QuestHandler
{
	private static final int questId = 29647;
	...
	public _29647Assisting_Grangund()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(804914).addOnTalkEvent(questId); // DF5 Grangund.
		for (int mob : mobs)
		{
