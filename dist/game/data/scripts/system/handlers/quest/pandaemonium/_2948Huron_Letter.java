...
{
	private static final int questId = 2948;
	...
	public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName)
	{
		...
		if ((qs != null) && (qs.getStatus() == QuestStatus.START))
		{
			...
			if (zoneName == ZoneName.get("VIFROST_BRIDGE_120010000"))
			{
				if (var == 0)
				{
					SystemMailService.getInstance().sendMail("Huron", player.getName(), "[Wing Feather Tuner]", "I'am Huron and I expect you at Pandaemonium. Come join me.", 0, 0, 0, LetterType.NORMAL);
					return true;
				}
			}
		}
