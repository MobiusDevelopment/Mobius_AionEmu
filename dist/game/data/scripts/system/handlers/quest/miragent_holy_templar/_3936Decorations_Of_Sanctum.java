			...
			switch (targetId)
			{
				case 203710: // Dairos.
				{
					switch (dialog)
					{
						...
						{
							final long itemCount1 = player.getInventory().getItemCountByItemId(182206091);
							final long itemCount2 = player.getInventory().getItemCountByItemId(182206092);
							final long itemCount3 = player.getInventory().getItemCountByItemId(182206093);
							final long itemCount4 = player.getInventory().getItemCountByItemId(182206094);
