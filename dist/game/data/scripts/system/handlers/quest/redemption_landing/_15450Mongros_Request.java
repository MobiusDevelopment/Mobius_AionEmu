...
{
	private static final int questId = 15450;
	...
	public void register()
	{
		...
		qe.registerOnEnterZone(ZoneName.get("ANCHORBRAK_ARTIFACT_OUTPOST_400010000"), questId);
	}
	...
	{
		if (zoneName == ZoneName.get("ANCHORBRAK_ARTIFACT_OUTPOST_400010000"))
		{
			final Player player = env.getPlayer();
			if (player == null)
			{
