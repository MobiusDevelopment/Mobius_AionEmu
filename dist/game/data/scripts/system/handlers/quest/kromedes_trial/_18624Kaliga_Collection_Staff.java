...
{
	private static final int questId = 18624;
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		{ // Kaliga's Staff Rack.
			...
			if (((playerClass == PlayerClass.PRIEST) || (playerClass == PlayerClass.CHANTER) || (playerClass == PlayerClass.CLERIC)) && (player.getCommonData().getRace() == Race.ELYOS))
			{
				if ((qs == null) || (qs.getStatus() == QuestStatus.NONE) || qs.canRepeat())
				{
