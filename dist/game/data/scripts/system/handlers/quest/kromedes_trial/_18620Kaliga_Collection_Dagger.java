...
public class _18620Kaliga_Collection_Dagger extends QuestHandler
{
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		if (targetId == 730328) // Kaliga's Dagger Rack.
		{
			...
			if (((playerClass == PlayerClass.WARRIOR) || (playerClass == PlayerClass.SCOUT) || (playerClass == PlayerClass.GLADIATOR) || (playerClass == PlayerClass.ASSASSIN) || (playerClass == PlayerClass.RANGER)) && (player.getCommonData().getRace() == Race.ELYOS))
			{
				if ((qs == null) || (qs.getStatus() == QuestStatus.NONE) || qs.canRepeat())
				{
