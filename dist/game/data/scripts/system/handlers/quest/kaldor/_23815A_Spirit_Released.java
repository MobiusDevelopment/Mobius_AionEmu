 ...
 */
public class _23815A_Spirit_Released extends QuestHandler
{
	private static final int questId = 23815;
	
	public _23815A_Spirit_Released()
	{
		super(questId);
	}
	...
	{
		qe.registerQuestNpc(804591).addOnTalkEvent(questId); // Salonte.
