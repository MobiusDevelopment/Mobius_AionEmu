 ...
 */
public class _41046Fighting_In_Fulminaer extends QuestHandler
{
	private static final int questId = 41046;
	
	public _41046Fighting_In_Fulminaer()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(802535).addOnQuestStart(questId);
		qe.registerQuestNpc(802535).addOnTalkEvent(questId);
	}
