 ...
 */
public class _41061Cold_And_Disilveir extends QuestHandler
{
	private static final int questId = 41061;
	
	public _41061Cold_And_Disilveir()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(802529).addOnQuestStart(questId);
		qe.registerQuestNpc(802529).addOnTalkEvent(questId);
	}
