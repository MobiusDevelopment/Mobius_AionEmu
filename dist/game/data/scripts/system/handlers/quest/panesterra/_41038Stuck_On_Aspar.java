 ...
 */
public class _41038Stuck_On_Aspar extends QuestHandler
{
	private static final int questId = 41038;
	
	public _41038Stuck_On_Aspar()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(802501).addOnQuestStart(questId);
		qe.registerQuestNpc(802501).addOnTalkEvent(questId);
	}
