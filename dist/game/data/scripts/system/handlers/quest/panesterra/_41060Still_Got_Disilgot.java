...
public class _41060Still_Got_Disilgot extends QuestHandler
{
	private static final int questId = 41060;
	
	public _41060Still_Got_Disilgot()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(802525).addOnQuestStart(questId);
		qe.registerQuestNpc(802525).addOnTalkEvent(questId);
	}
