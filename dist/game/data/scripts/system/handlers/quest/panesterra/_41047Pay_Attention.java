 ...
 */
public class _41047Pay_Attention extends QuestHandler
{
	private static final int questId = 41047;
	
	public _41047Pay_Attention()
	{
		super(questId);
	}
	...
	public void register()
	{
		...
		qe.registerQuestNpc(802539).addOnQuestStart(questId);
		qe.registerQuestNpc(802539).addOnTalkEvent(questId);
	}
