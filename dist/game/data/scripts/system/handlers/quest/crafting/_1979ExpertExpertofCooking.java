			...
			switch (targetId)
			{
				case 203784:
				{
					switch (env.getDialog())
					{
						case START_DIALOG:
						{
							final long itemCount1 = player.getInventory().getItemCountByItemId(182206902);
							final long itemCount2 = player.getInventory().getItemCountByItemId(182206903);
							final long itemCount3 = player.getInventory().getItemCountByItemId(182206904);
							final long itemCount4 = player.getInventory().getItemCountByItemId(182206905);
