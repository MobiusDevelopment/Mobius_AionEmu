			...
			switch (targetId)
			{
				case 204100:
				{
					switch (env.getDialog())
					{
						case START_DIALOG:
						{
							final long itemCount1 = player.getInventory().getItemCountByItemId(182207972);
							final long itemCount2 = player.getInventory().getItemCountByItemId(182207973);
							final long itemCount3 = player.getInventory().getItemCountByItemId(182207974);
