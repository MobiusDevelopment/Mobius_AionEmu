...
public class _1978ExpertPassionforCooking extends QuestHandler
{
	...
	private static final int questId = 1978;
			...
			switch (targetId)
			{
				case 203784:
				{
					switch (env.getDialog())
					{
						case START_DIALOG:
						{
							final long itemCount1 = player.getInventory().getItemCountByItemId(182206919);
							final long itemCount2 = player.getInventory().getItemCountByItemId(182206920);
							final long itemCount3 = player.getInventory().getItemCountByItemId(182206921);
