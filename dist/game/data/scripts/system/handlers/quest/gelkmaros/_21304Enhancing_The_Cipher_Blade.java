...
public class _21304Enhancing_The_Cipher_Blade extends QuestHandler
{
	private static final int questId = 21304;
	
	public _21304Enhancing_The_Cipher_Blade()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Usener.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(102100586, 1);
						player.getInventory().decreaseByItemId(182213562, 1);
