 ...
 */
public class _21302Enhancing_The_Harp extends QuestHandler
{
	private static final int questId = 21302;
	
	public _21302Enhancing_The_Harp()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Usener.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(102000691, 1);
						player.getInventory().decreaseByItemId(182213296, 1);
