...
public class _21298Enhancing_The_Gun extends QuestHandler
{
	private static final int questId = 21298;
	
	public _21298Enhancing_The_Gun()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Usener.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(101800656, 1);
						player.getInventory().decreaseByItemId(182213294, 1);
