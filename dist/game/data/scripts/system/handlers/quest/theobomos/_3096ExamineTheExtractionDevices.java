...
public class _3096ExamineTheExtractionDevices extends QuestHandler
{
	...
	private static final int questId = 3096;
			...
			switch (targetId)
			{
				case 798225:
				{
					switch (env.getDialog())
					{
						case START_DIALOG:
						{
							final long itemCount1 = player.getInventory().getItemCountByItemId(182208067);
							final long itemCount2 = player.getInventory().getItemCountByItemId(182208068);
							final long itemCount3 = player.getInventory().getItemCountByItemId(182208069);
							final long itemCount4 = player.getInventory().getItemCountByItemId(182208070);
						...
						case SELECT_NO_REWARD:
						{
							...
							final int rewardKinah = (int) (player.getRates().getQuestKinahRate() * rewards.getGold());
