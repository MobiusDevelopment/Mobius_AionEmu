 ...
 */
public class _19646What_Beritra_Is_After extends QuestHandler
{
	private static final int questId = 19646;
	
	public _19646What_Beritra_Is_After()
	{
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		{
			if (targetId == 804704) // LF5 Eukraton.
			{
				switch (dialog)
				{
					case SELECT_REWARD:
