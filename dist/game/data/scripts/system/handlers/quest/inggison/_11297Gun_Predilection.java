 ...
 */
public class _11297Gun_Predilection extends QuestHandler
{
	private static final int questId = 11297;
	
	public _11297Gun_Predilection()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Anusis.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(101800652, 1);
						player.getInventory().decreaseByItemId(182213291, 1);
