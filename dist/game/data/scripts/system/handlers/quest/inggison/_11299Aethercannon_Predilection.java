...
public class _11299Aethercannon_Predilection extends QuestHandler
{
	private static final int questId = 11299;
	
	public _11299Aethercannon_Predilection()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Anusis.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(101900651, 1);
						player.getInventory().decreaseByItemId(182213292, 1);
