...
public class _11301Harp_Predilection extends QuestHandler
{
	private static final int questId = 11301;
	
	public _11301Harp_Predilection()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Anusis.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(102000686, 1);
						player.getInventory().decreaseByItemId(182213293, 1);
