 ...
 */
public class _11303Cipher_Blade_Predilection extends QuestHandler
{
	private static final int questId = 11303;
	
	public _11303Cipher_Blade_Predilection()
	{
		super(questId);
	}
		...
		else if (qs.getStatus() == QuestStatus.START)
		{
			...
			{ // Anusis.
				...
				else if (dialog == QuestDialog.CHECK_COLLECTED_ITEMS)
				{
					...
					{
						player.getInventory().decreaseByItemId(102100582, 1);
						player.getInventory().decreaseByItemId(182213561, 1);
