...
{
	private static final int questId = 10034;
						...
						case STEP_TO_4:
						{
							if (var == 3)
							{
								if (player.getInventory().getItemCountByItemId(182215627) > 0)
								{
									...
									final WorldMapInstance IDTempleLow = InstanceService.getNextAvailableInstance(300160000);
	...
	public HandlerResult onItemUseEvent(QuestEnv env, Item item)
	{
		...
		if ((qs != null) && (qs.getStatus() == QuestStatus.START))
		{
			...
			if (itemId == 182215628)
			{
				...
				updateQuestStatus(env);
				TeleportService2.teleportTo(env.getPlayer(), 210050000, 389.17194f, 980.16077f, 460.25f, (byte) 2, TeleportAnimation.BEAM_ANIMATION);
