...
public class _1535TheColdColdGround extends QuestHandler
{
	...
	public boolean onDialogEvent(QuestEnv env)
	{
		...
		{
			final boolean abexSkins = player.getInventory().getItemCountByItemId(182201818) > 4;
			final boolean worgSkins = player.getInventory().getItemCountByItemId(182201819) > 2;
			final boolean karnifSkins = player.getInventory().getItemCountByItemId(182201820) > 0;
