...
/**
 * Go to Draupnir Cave in Asmodae and get Blue Balaur Blood (186000035) (2) and Balaur Rainbow Scales (186000036) (5) for Brosia (204601). Go to Brosia to choose your reward.
 * @author Balthazar
 * @reworked vlog
 */
			...
			{ // Brosia
				switch (env.getDialog())
				{
					...
					case CHECK_COLLECTED_ITEMS:
					{
						...
						final long collect2 = player.getInventory().getItemCountByItemId(186000036);
