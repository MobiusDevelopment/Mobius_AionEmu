...
public class _1922Deliveron_Your_Promises extends QuestHandler
{
	...
	private static final int questId = 1922;
			...
			switch (targetId)
			{
				...
				{ // Epeios.
					switch (env.getDialog())
					{
						...
						case STEP_TO_3:
						{
							final WorldMapInstance sanctumUndergroundArena = InstanceService.getNextAvailableInstance(310080000); // Sanctum Underground Arena.
