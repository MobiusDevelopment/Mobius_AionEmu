...
public class _2947Following_Through extends QuestHandler
{
	...
	private static final int questId = 2947;
			...
			switch (targetId)
			{
				...
				{ // Garm.
					switch (env.getDialog())
					{
						...
						case STEP_TO_3:
						{
							final WorldMapInstance trinielUndergroundArena = InstanceService.getNextAvailableInstance(320090000); // Triniel Underground Arena.
