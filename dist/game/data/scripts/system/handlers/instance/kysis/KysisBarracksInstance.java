...
public class KysisBarracksInstance extends GeneralInstanceHandler
{
	...
	private Future<?> chestKysisBarracksTask;
	private final List<Npc> kysisBarracksChest = new ArrayList<>();
	...
	public void onEnterInstance(Player player)
	{
		...
		if (!isStartTimer1)
		{
			...
			kysisBarracksChest.add((Npc) spawn(702292, 471.32745f, 834.5498f, 199.76048f, (byte) 63));
			kysisBarracksChest.add((Npc) spawn(702292, 470.52844f, 854.9471f, 199.76048f, (byte) 56));
			kysisBarracksChest.add((Npc) spawn(702293, 477.76843f, 873.94354f, 199.76036f, (byte) 50));
			kysisBarracksChest.add((Npc) spawn(702293, 490.90323f, 889.6053f, 199.76036f, (byte) 43));
			kysisBarracksChest.add((Npc) spawn(702293, 508.64328f, 899.91547f, 199.76036f, (byte) 36));
			kysisBarracksChest.add((Npc) spawn(702294, 528.42053f, 903.5909f, 199.76036f, (byte) 29));
			kysisBarracksChest.add((Npc) spawn(702294, 548.2363f, 900.31604f, 199.76036f, (byte) 23));
			kysisBarracksChest.add((Npc) spawn(702294, 565.53644f, 890.173f, 199.76036f, (byte) 16));
