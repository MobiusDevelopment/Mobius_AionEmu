...
/****/
/**
 * Author Rinzler (Encom) Source: https://www.youtube.com/watch?v=dPpM-kCTrOU /
 ****/
...
public class OphidanWarpathInstance extends GeneralInstanceHandler
{
	...
	protected void reward()
	{
		...
		for (Player player : instance.getPlayersInside())
		{
			...
			final EngulfedOphidanBridgePlayerReward playerReward = engulfedOphidanBridgeReward.getPlayerReward(player.getObjectId());
			int abyssPoint = 3163;
			int gloryPoint = 150;
			int expPoint = 10000;
	...
	{
		final EngulfedOphidanBridgePlayerReward ownerReward = engulfedOphidanBridgeReward.getPlayerReward(player.getObjectId());
		...
		if (lastAttacker instanceof Player)
		{
			...
			{
				final InstancePlayerReward playerReward = engulfedOphidanBridgeReward.getPlayerReward(player.getObjectId());
	...
	{
		if (zone.getAreaTemplate().getZoneName() == ZoneName.get("IDLDF5_Under_01_War_SZ_S2_301670000"))
		{
			powerGenerator = 1;
		}
		else if (zone.getAreaTemplate().getZoneName() == ZoneName.get("IDLDF5_Under_01_War_SZ_S3_301670000"))
		{
			powerGenerator = 2;
		}
	}
	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 243963: // 눈길 고개 만두리.
			case 243964: // 난폭한 눈길 고개 만두리.
				point = 25;
				despawnNpc(npc);
				break;
		}
	...
	{
		clearOphidanBridgeDebuffs(player);
