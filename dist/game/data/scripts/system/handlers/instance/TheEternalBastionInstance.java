...
/**
 * Author Rinzler (Encom) //http://aion.power.plaync.com/wiki/%EC%B2%A0%EB%B2%BD%EC%9D%98+%EB%B3%B4%EB%A3%A8+-+%EC%A7%84%ED%96%89+%EC%A0%95%EB%B3%B4#hd144945 24人の精鋭で行われるミニ守城型インスタンス ダンジョン！ 鉄壁の砦は、南部カタラムの南側、ベリトラ軍の陸上浸透路を監視する監視基地であり、最後の関門である。 ベリトラ軍が関門を通れないように、押し寄せてくる敵を倒し、最後まで生き残り、要塞を守らなければならない。
 * -入場制限は65レベル以上 -南部カタラムにある第81基地を占領すると、基地内部に入場するためのNPCが登場する。 -24人が参加するフォースIDに集まってくる敵を倒してディフェンスする。 -最後のウェーブで登場する最終ボスを倒せば、それまでにかかった時間と点数に応じてランクがつけられる。 -毎週水曜日午前9時に初期化 -入場時に血戦の証3個を消費 -基本報酬として、フォースメンバー全員に、スコアに応じて、アビスポイントが付与される。 -ランクに応じた追加報酬として、古代の遺物やセラミウムの功績勲章、ヒーローおよびミシックグレードのアイテムを獲得することができる。 背景ストーリー
 * 鉄壁の砦は、ルーン族がベリトラ領地と南部カタラムとの間に造られた関門であり、一時期は、ベリトラ軍がカタラムに進出する際の主な通路として使われ たが、天族・魔族がカタラムへ進出してからは、彼らに占領されたまま現在に至っている。 ベリトラ軍は、この重要な関門を取り戻すために、パシッド部隊をつくり、ドレドギオンと大量の物資を動員し、鉄壁の砦を攻略する準備を行っていた。ベリト ラ軍による大規模な攻撃がまもなく始まるとの噂を聞いた天族・魔族の司令部は、
 * 増員されたベリトラ軍の兵士がカタラムに進出することを防ぐために、勇猛なディーヴァに助けを求め、それに応じてくれたディーヴァと一緒に鉄壁の砦へ向かった。 鉄壁の砦の関門の城壁には、天族・魔族が守城のために設置した大砲を含む設備が整っており、近隣の地域にはパシッド部隊が設置した様々な前進 基地が造られている。鉄壁の砦に進入したディーヴァは、 ベリトラ軍の一斉攻勢を防ぐのはもちろんベリトラ軍の攻城施設を破壊し、パシッド部隊の司令官である総指揮官パシッドを撃退しなければならない。 場所 鉄壁の砦の入口は、南部カタラムにある第81基地の中にある。
 * 自分の種族が基地を占領した場合のみ入場することができ、入場時は、血戦の証3枚が必要となる。 -天族入場NPC: ダイタロス -魔族入場NPC: シュバンヒルト 獲得アイテム 鉄壁の砦を攻略すると、次のような内容で様々な報酬アイテムが付与される。 また最終的に獲得したランクによって報酬のクオリティが大きく異なり、高いランクに達成した際は、ミシック級の装備アイテムも入手することができる。 1.ランク達成基本報酬 ランクに応じて、フォースメンバー全員が平等に受け取る報酬 アビスポイントやセラミウムの功績勲章、高級製作材料などがこれに当たる。 2.ランク宝箱報酬
 * ランクに応じて大きさが異なる宝箱が登場し、その中から様々な報酬を入手することができる。 ほとんどの報酬が数量に限りがあるため、他の参加者とサイコロ対決をし、勝った場合のみ獲得することができる。 3.拠点ネームド報酬 一種の追加報酬であり、ID内部の各拠点にあるネームド モンスターを倒せば、ベリトラ軍団の補給箱を入手することができる。 この箱を開けると、ランダムで複合魔石を入手することができる。 ランク: S 92,000点 アビスポイント35,000 セラミウムの功績勲章4個 最上級材料箱 最上級材料支援袋 リジッド スティール ウォール セット-武器or防具 × 1 スティール
 * ウォール セット-武器 × 1 スティール ウォール セット-防具 × 1 関門の戦闘補給箱 × 4 関門 補給魔力付与の袋 × 1 要塞戦の報酬スティグマの袋 × 5 パシッドの戦利品袋 × 1 最上級遺物箱 × 1(フォース ドロップ) ランク: A 84,000点 アビスポイント25,000 セラミウムの功績勲章2個 最上級材料箱 上級材料支援袋 スティール ウォール セット-武器 × 1 スティール ウォール セット-防具 × 1 関門の戦闘補給箱 × 3 要塞戦の報酬スティグマの袋 × 5 パシッドの戦利品の袋 × 1 上級遺物箱 × 1(フォース ドロップ) ランク: B
 * 76,000点 アビスポイント15,000 セラミウムの功績勲章1個 上級材料箱 下級材料支援袋 スティール ウォール セット-防具 × 1 関門の戦闘補給箱 × 2 要塞戦の報酬スティグマの袋 × 4 中級遺物箱 × 1(フォース ドロップ) ランク: C 50,000点 アビスポイント11,000 下級材料支援袋 関門の戦闘補給箱 × 2 下級遺物箱 × 1(フォース ドロップ) ランク: D 10,000点 アビスポイント7,000 関門の戦闘補給箱 × 2 最下級遺物箱 × 1(フォース ドロップ) ランク: F 10,000点未満 装備アイテムについて
 * Bランク以上で攻略すると、宝箱の中から装備アイテムが出てくる。 ID攻略用としての使用に最適化されたオプションが付いており、ヒーロー級アイテムも魔石スロット6個を持っている。 1.堅固な鉄壁セット -Sランクを達成した場合に宝箱から武器/防具のいずれかが出てくる。 2.鉄壁セット -Aランク以上を達成した場合に宝箱から武器の一つが出てくる。 -Bランク以上を達成した場合に宝箱から防具の一つが出てくる。 補給箱について 鉄壁の砦では2種類の補給箱から魔石袋を入手することができる。 高級オプション付きの複合魔石や古代魔石などが入っている袋であるため、魅力的な報酬と言える。 1.関門戦闘補給箱
 * -ランクに応じて、宝箱からいくつかの関門の戦闘補給箱が出てくる。 -この箱を開けると、高級オプション付きの複合魔石と古代魔石のいずれかを入手することができる。 -この箱から入手できる古代魔石の中にはPvPオプションが付いているものもある。 2.ベリトラ軍の補給箱 -一種の追加報酬であり、各拠点にあるネームド モンスターを倒せば、ベリトラ軍団の補給箱を入手することができる。 -この箱を開けると、ランダムで複合魔石を入手することができる。 その他セット報酬 他にも、ランクの結果に応じて、以下のような様々な報酬が付与される。 1.関門 補給魔力付与の袋
 * -Sランクに達成した場合のみ追加報酬として入手できる袋 -袋を開けると「祝福された上級魔力付与:2段階」を入手することができる。 2.要塞戦の報酬スティグマの袋 -カタラム要塞戦の報酬として入手できるスティグマを鉄壁の砦でも入手することができる。 -Bランク以上を達成した場合に何個か出てくる。 3.パシッドの戦利品の袋 -ヒーロークエストである天族総司令官の足の爪、魔族総司令官の角の進行に必要なクエスト アイテム. -Aランク以上を達成した場合に入手することができる。
 **/
...
public class TheEternalBastionInstance extends GeneralInstanceHandler
{
	...
	{
		final EternalBastionPlayerReward playerReward = getPlayerReward(player.getObjectId());
		if (!playerReward.isRewarded())
		{
			playerReward.setRewarded();
			final int bastionRank = instanceReward.getRank();
			switch (bastionRank)
			{
				case 1: // Rank S
