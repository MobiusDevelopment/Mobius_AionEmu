...
public class ChaosTrainingGroundsInstance extends PvPArenaInstance
{
	...
	{
		final FlyRing f1 = new FlyRing(new FlyRingTemplate("PVP_ARENA_1", mapId, new Point3D(674.66974, 1792.8499, 149.77501), new Point3D(674.66974, 1792.8499, 155.77501), new Point3D(678.83636, 1788.5325, 149.77501), 6), instanceId);
		f1.spawn();
		final FlyRing f2 = new FlyRing(new FlyRingTemplate("PVP_ARENA_2", mapId, new Point3D(688.30615, 1769.7937, 149.88556), new Point3D(688.30615, 1769.7937, 155.88556), new Point3D(689.42096, 1763.8982, 149.88556), 6), instanceId);
		f2.spawn();
		final FlyRing f3 = new FlyRing(new FlyRingTemplate("PVP_ARENA_3", mapId, new Point3D(664.2252, 1761.671, 170.95732), new Point3D(664.2252, 1761.671, 176.95732), new Point3D(669.2843, 1764.8967, 170.95732), 6), instanceId);
		f3.spawn();
		final FlyRing fv1 = new FlyRing(new FlyRingTemplate("PVP_ARENA_VOID_1", mapId, new Point3D(690.28625, 1753.8561, 192.07726), new Point3D(690.28625, 1753.8561, 198.07726), new Point3D(689.4365, 1747.9165, 192.07726), 6), instanceId);
		fv1.spawn();
		final FlyRing fv2 = new FlyRing(new FlyRingTemplate("PVP_ARENA_VOID_2", mapId, new Point3D(690.1935, 1797.0029, 203.79236), new Point3D(690.1935, 1797.0029, 209.79236), new Point3D(692.8295, 1802.3928, 203.79236), 6), instanceId);
		fv2.spawn();
		final FlyRing fv3 = new FlyRing(new FlyRingTemplate("PVP_ARENA_VOID_3", mapId, new Point3D(659.2784, 1766.0273, 207.25465), new Point3D(659.2784, 1766.0273, 213.25465), new Point3D(665.2619, 1766.4718, 207.25465), 6), instanceId);
		fv3.spawn();
	}
	...
	{
		final PvPArenaPlayerReward playerReward = getPlayerReward(player.getObjectId());
