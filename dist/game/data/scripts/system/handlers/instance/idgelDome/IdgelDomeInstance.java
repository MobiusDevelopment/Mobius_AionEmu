...
public class IdgelDomeInstance extends GeneralInstanceHandler
{
	...
	protected IdgelDomePlayerReward getPlayerReward(Player player)
	{
		...
		return idgelDomeReward.getPlayerReward(player.getObjectId());
	}
	...
	protected void reward()
	{
		...
		for (Player player : instance.getPlayersInside())
		{
			...
			final IdgelDomePlayerReward playerReward = idgelDomeReward.getPlayerReward(player.getObjectId());
			int abyssPoint = 3163;
			int gloryPoint = 150;
			int expPoint = 10000;
	...
	{
		final IdgelDomePlayerReward ownerReward = idgelDomeReward.getPlayerReward(player.getObjectId());
		...
		if (lastAttacker instanceof Player)
		{
			...
			{
				final InstancePlayerReward playerReward = idgelDomeReward.getPlayerReward(player.getObjectId());
