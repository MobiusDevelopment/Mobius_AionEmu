...
public class TwilightBattlefieldStoreroomInstance extends GeneralInstanceHandler
{
	...
	private final List<Npc> twilightBattlefieldChest = new ArrayList<>();
	...
	public void onDie(Npc npc)
	{
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 215222: // Awakened Miren Prince.
			{
				...
				sendMsg("[Congratulation]: you finish <Miren Chamber>");
	...
	public void onEnterInstance(Player player)
	{
		...
		if (!isStartTimer1)
		{
			...
			twilightBattlefieldTask = ThreadPoolManager.getInstance().schedule(() ->
			{
				StartTimer2();
				sendMsg(1400245);
