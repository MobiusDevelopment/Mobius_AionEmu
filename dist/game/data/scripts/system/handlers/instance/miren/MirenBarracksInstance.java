 ...
 */
package system.handlers.instance.miren;
...
public class MirenBarracksInstance extends GeneralInstanceHandler
{
	...
	private Future<?> chestMirenBarracksTask;
	private final List<Npc> mirenBarracksChest = new ArrayList<>();
	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 233719: // Enraged Miren Prince.
				...
				chestMirenBarracksTask.cancel(true);
				sendMsg("[Congratulation]: you finish <Miren Barracks>");
	...
	public void onEnterInstance(final Player player)
	{
		...
		if (!isStartTimer1)
		{
			...
			mirenBarracksChest.add((Npc) spawn(702296, 478.56662f, 815.6565f, 199.76048f, (byte) 70));
			mirenBarracksChest.add((Npc) spawn(702296, 471.32745f, 834.5498f, 199.76048f, (byte) 63));
			mirenBarracksChest.add((Npc) spawn(702296, 470.52844f, 854.9471f, 199.76048f, (byte) 56));
			mirenBarracksChest.add((Npc) spawn(702297, 477.76843f, 873.94354f, 199.76036f, (byte) 50));
			mirenBarracksChest.add((Npc) spawn(702297, 490.90323f, 889.6053f, 199.76036f, (byte) 43));
			mirenBarracksChest.add((Npc) spawn(702297, 508.64328f, 899.91547f, 199.76036f, (byte) 36));
			mirenBarracksChest.add((Npc) spawn(702298, 528.42053f, 903.5909f, 199.76036f, (byte) 29));
			mirenBarracksChest.add((Npc) spawn(702298, 548.2363f, 900.31604f, 199.76036f, (byte) 23));
			mirenBarracksChest.add((Npc) spawn(702298, 565.53644f, 890.173f, 199.76036f, (byte) 16));
			mirenBarracksChest.add((Npc) spawn(702299, 578.9111f, 874.7958f, 199.76036f, (byte) 9));
			mirenBarracksChest.add((Npc) spawn(702299, 585.83545f, 855.7736f, 199.76036f, (byte) 3));
			mirenBarracksChest.add((Npc) spawn(702299, 586.7527f, 835.4556f, 199.76036f, (byte) 116));
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				@Override
				public void run()
				{
					StartTimer2();
					sendMsg(1400245);
					mirenBarracksChest.get(0).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer2)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer3();
					sendMsg(1400245);
					mirenBarracksChest.get(1).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer3)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer4();
					sendMsg(1400245);
					mirenBarracksChest.get(2).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer4)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer5();
					sendMsg(1400245);
					mirenBarracksChest.get(3).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer5)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer6();
					sendMsg(1400245);
					mirenBarracksChest.get(4).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer6)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer7();
					sendMsg(1400245);
					mirenBarracksChest.get(5).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer7)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer8();
					sendMsg(1400245);
					mirenBarracksChest.get(6).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer8)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer9();
					sendMsg(1400245);
					mirenBarracksChest.get(7).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer9)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer10();
					sendMsg(1400245);
					mirenBarracksChest.get(8).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer10)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer11();
					sendMsg(1400245);
					mirenBarracksChest.get(9).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer11)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer12();
					sendMsg(1400245);
					mirenBarracksChest.get(10).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer12)
		{
			...
			chestMirenBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					sendMsg(1400244);
					sendMsg(1400245);
					mirenBarracksChest.get(11).getController().onDelete();
				}
			}, 300000);
		}
	}
