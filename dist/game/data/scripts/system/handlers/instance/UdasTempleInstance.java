 ...
 * specific monster in order to open the door. Three Named Elite class Dragonbound randomly spawn. You have to weaken the Chamber of Unity by defeating each of them. One of these resides in the Silent Chapel, which requires a key that can be obtained from "Cota the Gatekeeper". But "Cota the
 * Gatekeeper" does not affect the seal on the chamber. Once in the Chamber of Unity, you will face Vallakhan, a Hero grade Dragonbound. From him, you will obtain the key to the Great Chapel. Once you defeat Vallakhan, you will receive the key to the Great Chapel. Anurati resides here and has a
 * chance to drop Heroic accessories and Fabled weapons. You must defeat another named Dragonbound in order to receive the Key to the Chamber of Guidance. He is located in the area hilighted above. Once inside the Chamber of Guidance, you will face Nexus, the final boss of Udas Temple.
 **/
