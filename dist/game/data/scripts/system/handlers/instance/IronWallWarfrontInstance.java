...
public class IronWallWarfrontInstance extends GeneralInstanceHandler
{
	...
	protected IronWallWarfrontPlayerReward getPlayerReward(Player player)
	{
		...
		return ironWallWarfrontReward.getPlayerReward(player.getObjectId());
	}
	...
	protected void reward()
	{
		...
		for (Player player : instance.getPlayersInside())
		{
			...
			final IronWallWarfrontPlayerReward playerReward = ironWallWarfrontReward.getPlayerReward(player.getObjectId());
			int abyssPoint = 3163;
			int gloryPoint = 150;
			int expPoint = 10000;
	...
	{
		final IronWallWarfrontPlayerReward ownerReward = ironWallWarfrontReward.getPlayerReward(player.getObjectId());
		...
		if (lastAttacker instanceof Player)
		{
			...
			{
				final InstancePlayerReward playerReward = ironWallWarfrontReward.getPlayerReward(player.getObjectId());
	...
	private void clearWarfrontDebuffs(Player player)
	{
