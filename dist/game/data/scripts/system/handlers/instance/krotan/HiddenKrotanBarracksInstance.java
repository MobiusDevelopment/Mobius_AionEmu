...
public class HiddenKrotanBarracksInstance extends GeneralInstanceHandler
{
	...
	private Future<?> chestHKRBarracksTask;
	private final List<Npc> HKRBarracksChest = new ArrayList<>();
		...
		switch (npcId)
		{
			...
			case 233633: // Enraged Krotan Lord.
				for (final Player player : instance.getPlayersInside())
				{
					...
					{
						case 1:
							dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 120001585, 1)); // Ereshkigal Legion Red Beryl Earrings.
							break;
						case 2:
							dropItems.add(DropRegistrationService.getInstance().regDropItem(1, 0, npcId, 120001586, 1)); // Ereshkigal Legion Turquoise Earrings.
							break;
					}
				}
				break;
	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 233633: // Enraged Krotan Lord.
				...
				chestHKRBarracksTask.cancel(true);
				sendMsg("[Congratulation]: you finish <Hidden Krotan Barracks>");
	...
	public void onEnterInstance(final Player player)
	{
		...
		if (!isStartTimer1)
		{
			...
			HKRBarracksChest.add((Npc) spawn(702028, 478.56662f, 815.6565f, 199.76048f, (byte) 70));
			HKRBarracksChest.add((Npc) spawn(702028, 471.32745f, 834.5498f, 199.76048f, (byte) 63));
			HKRBarracksChest.add((Npc) spawn(702028, 470.52844f, 854.9471f, 199.76048f, (byte) 56));
			HKRBarracksChest.add((Npc) spawn(702029, 477.76843f, 873.94354f, 199.76036f, (byte) 50));
			HKRBarracksChest.add((Npc) spawn(702029, 490.90323f, 889.6053f, 199.76036f, (byte) 43));
			HKRBarracksChest.add((Npc) spawn(702029, 508.64328f, 899.91547f, 199.76036f, (byte) 36));
			HKRBarracksChest.add((Npc) spawn(702030, 528.42053f, 903.5909f, 199.76036f, (byte) 29));
			HKRBarracksChest.add((Npc) spawn(702030, 548.2363f, 900.31604f, 199.76036f, (byte) 23));
			HKRBarracksChest.add((Npc) spawn(702030, 565.53644f, 890.173f, 199.76036f, (byte) 16));
			HKRBarracksChest.add((Npc) spawn(702031, 578.9111f, 874.7958f, 199.76036f, (byte) 9));
			HKRBarracksChest.add((Npc) spawn(702031, 585.83545f, 855.7736f, 199.76036f, (byte) 3));
			HKRBarracksChest.add((Npc) spawn(702031, 586.7527f, 835.4556f, 199.76036f, (byte) 116));
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				@Override
				public void run()
				{
					StartTimer2();
					sendMsg(1400245);
					HKRBarracksChest.get(0).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer2)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer3();
					sendMsg(1400245);
					HKRBarracksChest.get(1).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer3)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer4();
					sendMsg(1400245);
					HKRBarracksChest.get(2).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer4)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer5();
					sendMsg(1400245);
					HKRBarracksChest.get(3).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer5)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer6();
					sendMsg(1400245);
					HKRBarracksChest.get(4).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer6)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer7();
					sendMsg(1400245);
					HKRBarracksChest.get(5).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer7)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer8();
					sendMsg(1400245);
					HKRBarracksChest.get(6).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer8)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer9();
					sendMsg(1400245);
					HKRBarracksChest.get(7).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer9)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer10();
					sendMsg(1400245);
					HKRBarracksChest.get(8).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer10)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer11();
					sendMsg(1400245);
					HKRBarracksChest.get(9).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer11)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					StartTimer12();
					sendMsg(1400245);
					HKRBarracksChest.get(10).getController().onDelete();
				}
			}, 300000);
		}
	}
		...
		if (!isStartTimer12)
		{
			...
			chestHKRBarracksTask = ThreadPoolManager.getInstance().schedule(new Runnable()
			{
				...
				public void run()
				{
					sendMsg(1400244);
					sendMsg(1400245);
					HKRBarracksChest.get(11).getController().onDelete();
				}
			}, 300000);
		}
	}
