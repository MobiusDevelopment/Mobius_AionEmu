...
public class EmpyreanCrucibleInstance extends CrucibleInstance
{
	...
	{
		final boolean isNew = !instanceReward.containPlayer(player.getObjectId());
	...
	public void onDie(Npc npc)
	{
		...
		final EmpyreanStage es = getEmpyreanStage(npc);
		int point = 0;
		switch (npc.getNpcId())
		{
		...
		switch (npc.getNpcId())
		{
			...
			{
				despawnNpc(npc);
				if (getNpcs(217476).isEmpty() && getNpcs(217477).isEmpty() && getNpcs(217478).isEmpty() && getNpcs(217479).isEmpty())
				{
			...
			{
				despawnNpc(npc);
				if (getNpcs(217480).isEmpty() && getNpcs(217481).isEmpty() && getNpcs(217482).isEmpty() && getNpcs(217483).isEmpty())
				{
			...
			{
				despawnNpc(npc);
				if (getNpcs(205395).isEmpty() && getNpcs(205396).isEmpty() && getNpcs(205397).isEmpty() && getNpcs(205398).isEmpty())
				{
			...
			{
				despawnNpc(npc);
				if (getNpcs(205399).isEmpty() && getNpcs(205400).isEmpty() && getNpcs(205401).isEmpty() && getNpcs(205402).isEmpty())
				{
			...
			{
				despawnNpc(npc);
				if (getNpcs(217485).isEmpty() && getNpcs(217486).isEmpty() && getNpcs(217487).isEmpty() && getNpcs(217488).isEmpty())
				{
					sendEventPacket(StageType.START_STAGE_1_ROUND_2, 2000);
					// Round %0 begins!
					sendMsgByRace(1400928, Race.PC_ALL, 4000);
			...
			{
				despawnNpc(npc);
				if (getNpcs(217489).isEmpty() && getNpcs(217490).isEmpty() && getNpcs(217491).isEmpty() && getNpcs(217492).isEmpty())
				{
					sendEventPacket(StageType.START_STAGE_1_ROUND_3, 2000);
					// Round %0 begins!
					sendMsgByRace(1400928, Race.PC_ALL, 4000);
			...
			{
				despawnNpc(npc);
				if (getNpcs(205404).isEmpty() && getNpcs(205405).isEmpty() && getNpcs(205406).isEmpty() && getNpcs(205407).isEmpty())
				{
					sendEventPacket(StageType.START_STAGE_1_ROUND_4, 2000);
					// Round %0 begins!
					sendMsgByRace(1400928, Race.PC_ALL, 4000);
			...
			{
				despawnNpc(npc);
				if (getNpcs(205408).isEmpty() && getNpcs(205409).isEmpty() && getNpcs(205410).isEmpty() && getNpcs(205411).isEmpty())
				{
					sendEventPacket(StageType.START_STAGE_1_ROUND_5, 2000);
					// Round %0 begins!
					sendMsgByRace(1400928, Race.PC_ALL, 4000);
			...
			{
				despawnNpc(npc);
				if (getNpcs(217530).isEmpty() && getNpcs(217531).isEmpty())
				{
			...
			{
				despawnNpc(npc);
				if (getNpcs(217532).isEmpty() && getNpcs(217533).isEmpty() && getNpcs(217534).isEmpty() && getNpcs(217535).isEmpty() && getNpcs(217536).isEmpty())
				{
			...
			/**
			 * Stage 7 is not same for player "Elyos/Asmodians" [Asmodians Version]
			 */
			case 217578:
			{
				despawnNpc(npc);
			...
			case 217597:
			{
				final Npc counterpart = getNpc(npc.getNpcId() == 217596 ? 217597 : 217596);
			...
			{
				despawnNpc(npc);
				if (getNpcs(217600).isEmpty() && getNpcs(217601).isEmpty() && getNpcs(217602).isEmpty())
				{
			...
			{
				despawnNpc(npc);
				if (getNpcs(217603).isEmpty() && getNpcs(217604).isEmpty() && getNpcs(217605).isEmpty() && getNpcs(217606).isEmpty())
				{
	...
	{
		final CruciblePlayerReward playerReward = getPlayerReward(player.getObjectId());
		final float reward = 0.02f * playerReward.getPoints();
		if (!playerReward.isRewarded())
		{
	...
	{
		final CruciblePlayerReward reward = getPlayerReward(player.getObjectId());
		removeItems(player);
