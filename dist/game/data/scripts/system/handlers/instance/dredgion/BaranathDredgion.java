 ...
 */
package system.handlers.instance.dredgion;
...
public class BaranathDredgion extends GeneralInstanceHandler
{
	...
	public void onDie(Npc npc)
	{
		...
		{
			/**
			 * Rescue Prisoners: olding the named monster of a prisoner receiving chamber can accommodate prisoners get a room key. When you open the container chamber prisoner standing in the room with the key to rescue the prisoners to obtain a score of 100 points. Conversely, it is possible to
			 * obtain a 100-point touch the opponent, like captive species.
			 */
			 ...
			 * to reach the center of the Dredgion. In some cases, it might wiser for one Group to destroy their own Defense Shield Generator, and delay engagement with the opposing race in order to accumulate more points.
			 */
			 ...
			 * Monster, will spawn. Adjutant Kalanadi has a chance to drop Fabled and Heroic accessories.
			 */
