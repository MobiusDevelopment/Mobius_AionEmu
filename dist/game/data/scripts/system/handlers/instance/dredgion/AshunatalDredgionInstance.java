...
public class AshunatalDredgionInstance extends GeneralInstanceHandler
{
	...
	private void onDieSurkan(Npc npc, Player mostPlayerDamage, int points)
	{
		...
		if (++surkanaKills == 5)
		{
			...
			PacketSendUtility.sendSys3Message(mostPlayerDamage, "\uE050", "<Frigate Commander Ashunatal> is now in the Captain's Cabin");
	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			 ...
			 * Monster, will spawn. Rajaya the Inquisitor has a chance to drop Fabled and Heroic accessories.
			 */
