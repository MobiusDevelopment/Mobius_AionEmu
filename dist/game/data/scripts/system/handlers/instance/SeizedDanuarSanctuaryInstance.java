...
public class SeizedDanuarSanctuaryInstance extends GeneralInstanceHandler
{
	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 235621: // Virulent Ukahim.
			{
				...
				{
					spawnAbbeyNobleBox();
					sendMsg("[Congratulation]: you finish <Seized Danuar Sanctuary 4.8>");
	...
	{
		final SpawnTemplate sturdyBoulder = SpawnEngine.addNewSingleTimeSpawn(301140000, 233187, 906.1991f, 859.88177f, 278.64731f, (byte) 37);
