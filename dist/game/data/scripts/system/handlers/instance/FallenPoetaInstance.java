	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 703290: // Dark Spore Road Iron Fence.
				switch (player.getRace())
				{
					case ELYOS:
						despawnNpc(npc);
						deleteNpc(833856);
						deleteNpc(243682); // Lieutenant Anuhart.
						// A teleport device for Kroban’s Burning Base was created.
						sendMsgByRace(1403559, Race.PC_ALL, 0);
			...
			case 243683: // Brigade General Tahabata.
				despawnNpc(npc);
				spawn(833853, 230.84657f, 333.07785f, 132.64389f, (byte) 48);
			...
			case 243684: // Artifact Overlord Kroban.
				...
				sendMsg("[Congratulation]: you finish <Fallen Poeta 5.1>");
				final SpawnTemplate fallenPoetaOut = SpawnEngine.addNewSingleTimeSpawn(301660000, 833852, 1179.0000f, 1223.0000f, 146.00000f, (byte) 0);
				fallenPoetaOut.setEntityId(223);
				objects.put(833852, SpawnEngine.spawnObject(fallenPoetaOut, instanceId));
				break;
		}
	}
