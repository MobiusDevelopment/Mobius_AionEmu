...
public class NightmareCircusInstance extends GeneralInstanceHandler
{
	...
	public void onInstanceCreate(WorldMapInstance instance)
	{
		...
		final SpawnTemplate ClosedCage = SpawnEngine.addNewSingleTimeSpawn(301160000, 831627, 522.39825f, 564.69006f, 199.03371f, (byte) 0);
		ClosedCage.setEntityId(142);
		objects.put(831627, SpawnEngine.spawnObject(ClosedCage, instanceId));
		final SpawnTemplate SolidIronChain = SpawnEngine.addNewSingleTimeSpawn(301160000, 831572, 522.04095f, 565.48944f, 199.34138f, (byte) 0);
	...
	public void onEnterInstance(Player player)
	{
		...
		player.getSkillList().addSkill(player, 21460, 1);
		player.getSkillList().addSkill(player, 21461, 1);
		player.getSkillList().addSkill(player, 21463, 1);
		
		player.getSkillList().addSkill(player, 21455, 1);
		player.getSkillList().addSkill(player, 21456, 1);
		player.getSkillList().addSkill(player, 21457, 1);
		player.getSkillList().addSkill(player, 21458, 1);
	...
	public void onDie(Npc npc)
	{
		...
		switch (npc.getObjectTemplate().getTemplateId())
		{
			...
			case 233161:
			{
				...
				sendMsg("[Congratulation]: you finish <Nightmare Circus>");
				final SpawnTemplate OpenCage = SpawnEngine.addNewSingleTimeSpawn(301160000, 831598, 522.39825f, 564.69006f, 199.03371f, (byte) 0);
	...
	private void removeEffects(Player player)
	{
		...
		SkillLearnService.removeSkill(player, 21459);
		SkillLearnService.removeSkill(player, 21462);
		SkillLearnService.removeSkill(player, 21460);
		SkillLearnService.removeSkill(player, 21461);
		SkillLearnService.removeSkill(player, 21463);
		
		SkillLearnService.removeSkill(player, 21455);
		SkillLearnService.removeSkill(player, 21456);
		SkillLearnService.removeSkill(player, 21457);
		SkillLearnService.removeSkill(player, 21458);
