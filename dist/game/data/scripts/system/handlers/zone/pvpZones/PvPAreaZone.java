...
public class PvPAreaZone extends PvPZone
{
	...
	protected void doTeleport(Player player, ZoneName zoneName)
	{
		...
		{
			TeleportService2.teleportTo(player, 110010000, 1465.1226f, 1336.6649f, 566.41583f, (byte) 92, TeleportAnimation.BEAM_ANIMATION);
		}
		else if (zoneName == ZoneName.get("DC1_PVP_ZONE"))
		{
			TeleportService2.teleportTo(player, 120010000, 1004.49927f, 1528.2157f, 222.19403f, (byte) 52, TeleportAnimation.BEAM_ANIMATION);
		}
	}
}