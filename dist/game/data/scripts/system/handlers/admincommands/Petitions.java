...
public class Petitions extends AdminCommand
{
	...
	public void execute(Player admin, String... params)
	{
		...
		{
			final Collection<Petition> petitions = PetitionService.getInstance().getRegisteredPetitions();
			final Petition[] petitionsArray = petitions.toArray(new Petition[0]);
		...
		final Petition petition = DAOManager.getDAO(PetitionDAO.class).getPetitionById(petitionId);
