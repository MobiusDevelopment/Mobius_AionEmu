 ...
 */
@AIName("castle_gate")
public class CastleGateAI2 extends NpcAI2
{
	...
	void moveToAcross(Player responder)
	{
		...
		final float x = (float) (Math.cos(radian) * 10.0D); // Forward 10M.
		final float y = (float) (Math.sin(radian) * 10.0D); // Forward 10M.
	...
	protected void handleDied()
	{
		World.getInstance().doOnAllPlayers(player ->
		{
			...
			if (winner instanceof Creature)
			{
				...
				AI2Actions.deleteOwner(CastleGateAI2.this);
