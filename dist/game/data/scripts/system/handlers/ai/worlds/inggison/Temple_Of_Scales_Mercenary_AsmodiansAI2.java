 ...
 */
@AIName("temple_of_scales_mercenary_asmodians")
public class Temple_Of_Scales_Mercenary_AsmodiansAI2 extends GeneralNpcAI2
{
	@Override
	...
	private void announceMercenaries()
	{
		World.getInstance().doOnAllPlayers(new Visitor<Player>()
		{
			...
			{
				PacketSendUtility.sendBrightYellowMessage(player, "<Asmodians> call has mercenaries to defend <Temple Of Scales>");
			}
		});
	}
}