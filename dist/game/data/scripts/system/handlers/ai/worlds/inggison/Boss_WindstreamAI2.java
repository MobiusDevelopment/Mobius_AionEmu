...
public class Boss_WindstreamAI2 extends AggressiveNpcAI2
{
	...
	protected void handleDied()
	{
		switch (getNpcId())
		{
			...
			case 215584: // Titan Starturtle.
			{
				...
				ThreadPoolManager.getInstance().schedule(() -> despawnNpc(281817), 300000); // 5 Minutes.
				break;
			}
	...
	{
		World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_JUMP_TRIGGER_ON_INFO));
	}
