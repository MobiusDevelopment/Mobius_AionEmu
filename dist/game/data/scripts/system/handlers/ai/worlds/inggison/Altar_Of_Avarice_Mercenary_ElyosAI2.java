 ...
 */
@AIName("altar_of_avarice_mercenary_elyos")
public class Altar_Of_Avarice_Mercenary_ElyosAI2 extends GeneralNpcAI2
{
	@Override
	...
	private void announceMercenaries()
	{
		World.getInstance().doOnAllPlayers(new Visitor<Player>()
		{
			...
			{
				PacketSendUtility.sendBrightYellowMessage(player, "<Elyos> call has mercenaries to defend <Altar Of Avarice>");
			}
		});
	}
}