 ...
 */
@AIName("vorgaltem_citadel_mercenary_elyos")
public class Vorgaltem_Citadel_Mercenary_ElyosAI2 extends GeneralNpcAI2
{
	@Override
	...
	private void announceMercenaries()
	{
		World.getInstance().doOnAllPlayers(new Visitor<Player>()
		{
			...
			{
				PacketSendUtility.sendBrightYellowMessage(player, "<Elyos> call has mercenaries to defend <Vorgaltem Citadel>");
			}
		});
	}
}