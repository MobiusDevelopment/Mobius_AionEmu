...
@AIName("crimson_temple_mercenary_asmodians")
public class Crimson_Temple_Mercenary_AsmodiansAI2 extends GeneralNpcAI2
{
	@Override
	...
	private void announceMercenaries()
	{
		World.getInstance().doOnAllPlayers(new Visitor<Player>()
		{
			...
			{
				PacketSendUtility.sendBrightYellowMessage(player, "<Asmodians> call has mercenaries to defend <Crimson Temple>");
			}
		});
	}
}