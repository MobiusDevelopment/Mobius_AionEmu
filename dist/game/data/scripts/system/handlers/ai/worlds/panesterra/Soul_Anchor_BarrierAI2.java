...
public class Soul_Anchor_BarrierAI2 extends NpcAI2
{
	...
	void moveToAcrossSoulAnchorBarrier(Player responder)
	{
		...
		final float x = (float) (Math.cos(radian) * 35.0D); // Move Forward 35M.
		final float y = (float) (Math.sin(radian) * 35.0D); // Move Forward 35M.
