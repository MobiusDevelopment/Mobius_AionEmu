 ...
 */
package system.handlers.ai.event.prestigeCoins;
...
public class Prestige_Society_Medical_AttendantAI2 extends NpcAI2
{
	...
	protected void handleDialogStart(Player player)
	{
		...
		else
		{
			...
			PacketSendUtility.broadcastPacket(player, new SM_MESSAGE(player, "You do not have <Prestige Crystal> to exchange", ChatType.BRIGHT_YELLOW_CENTER), true);
		}
	}
