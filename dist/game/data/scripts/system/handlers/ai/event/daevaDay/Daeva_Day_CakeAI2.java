 ...
 */
package system.handlers.ai.event.daevaDay;
...
public class Daeva_Day_CakeAI2 extends NpcAI2
{
	...
	protected void handleDialogStart(Player player)
	{
		...
		{
			PacketSendUtility.broadcastPacket(player, new SM_MESSAGE(player, "You must have 1 <Aether Flame>", ChatType.BRIGHT_YELLOW_CENTER), true);
		}
	}
