...
public class Conquest_Gelkmaros_BossAI2 extends AggressiveNpcAI2
{
	...
	private void spawnQuestionablePortal()
	{
		...
		if (p != null)
		{
			ThreadPoolManager.getInstance().schedule((Runnable) () -> spawn(833022, p.getX(), p.getY(), p.getZ(), (byte) 0), 15000);
			ThreadPoolManager.getInstance().schedule((Runnable) () -> despawnNpc(833022), 300000); // 5 Minutes.
		}
	}
