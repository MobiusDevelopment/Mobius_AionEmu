 ...
 */
package system.handlers.ai.instance.ophidanBridge;
		...
		if (isAggred.compareAndSet(false, true))
		{
			switch (getNpcId())
			{
				case 235763: // Runaway Hirakiki Leader.
				{
					...
					hirakikiTask = ThreadPoolManager.getInstance().schedule((Runnable) () -> AI2Actions.deleteOwner(Runaway_HirakikiAI2.this), 480000);
					break;
				}
			}
		}
