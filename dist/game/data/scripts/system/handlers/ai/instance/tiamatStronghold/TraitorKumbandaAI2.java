...
public class TraitorKumbandaAI2 extends AggressiveNpcAI2
{
	...
	{
		ThreadPoolManager.getInstance().schedule((Runnable) () -> timeStop(), 5000);
	}
	
	private void scheduleRush()
	{
		ThreadPoolManager.getInstance().schedule((Runnable) () -> timeRush(), 5000);
	}
	
	private void scheduleSlow()
	{
		ThreadPoolManager.getInstance().schedule((Runnable) () -> timeSlow(), 5000);
	}
