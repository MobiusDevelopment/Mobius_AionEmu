...
public class Esoterrace_WindStream_3AI2 extends NpcAI2
{
	...
	private void startWindStream(Npc npc)
	{
		...
		{
			final Npc npc2 = (Npc) spawn(300250000, 703057, 392.27563f, 543.89026f, 318.3265f, (byte) 18, 0, 1);
	...
	private void windStreamAnnounce(Npc npc, int state)
	{
		...
		npc.getPosition().getWorld().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, new SM_WINDSTREAM_ANNOUNCE(1, 300250000, 161, state)));
	}
