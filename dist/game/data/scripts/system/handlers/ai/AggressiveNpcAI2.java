...
public class AggressiveNpcAI2 extends GeneralNpcAI2
{
	...
	private void IDEternityQHDFireBuff()
	{
		SkillEngine.getInstance().getSkill(getOwner(), 22943, 1, getOwner()).useNoAnimationSkill(); // IDEternity_Q_HD_Fire_Buff.
	}
	
	private void IDEternityQHDEarthBuff()
	{
		SkillEngine.getInstance().getSkill(getOwner(), 22944, 1, getOwner()).useNoAnimationSkill(); // IDEternity_Q_HD_Earth_Buff.
	}
	
	private void IDEternityQHDWaterBuff()
	{
		SkillEngine.getInstance().getSkill(getOwner(), 22945, 1, getOwner()).useNoAnimationSkill(); // IDEternity_Q_HD_Water_Buff.
	}
	
	private void IDEternityQHDAirBuff()
	{
		SkillEngine.getInstance().getSkill(getOwner(), 22969, 1, getOwner()).useNoAnimationSkill(); // IDEternity_Q_HD_Air_Buff.
	}
	...
	public AttackIntention chooseAttackIntention()
	{
		...
		{
			final NpcSkillEntry skill = getOwner().getSkillList().getRandomSkill();
			if (skill != null)
			{
