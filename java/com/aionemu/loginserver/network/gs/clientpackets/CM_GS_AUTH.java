...
import com.aionemu.loginserver.network.gs.serverpackets.SM_GS_AUTH_RESPONSE;
import com.aionemu.loginserver.network.gs.serverpackets.SM_MACBAN_LIST;
...
public class CM_GS_AUTH extends GsClientPacket
{
	...
	{
		final GsConnection client = getConnection();
		
		final GsAuthResponse resp = GameServerTable.registerGameServer(client, gameServerId, defaultAddress, ipRanges, port, maxPlayers, password);
		switch (resp)
		{
			case AUTHED:
			{
