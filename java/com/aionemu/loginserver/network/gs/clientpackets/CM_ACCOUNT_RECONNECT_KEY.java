...
import com.aionemu.loginserver.network.gs.serverpackets.SM_ACCOUNT_RECONNECT_KEY;
...
public class CM_ACCOUNT_RECONNECT_KEY extends GsClientPacket
{
	...
	{
		final int reconectKey = Rnd.nextInt();
		final Account acc = getConnection().getGameServerInfo().removeAccountFromGameServer(accountId);
		if (acc == null)
		{
