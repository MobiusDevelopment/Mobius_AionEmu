...
public class BroadcastService
{
	...
	private final Map<Integer, ChatClient> clients = PlatformDependent.newConcurrentHashMap();
	...
	{
		for (final ChatClient client : clients.values())
		{
	...
	{
		final ClientChannelHandler cch = chatClient.getChannelHandler();
