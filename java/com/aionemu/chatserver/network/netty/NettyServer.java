...
import com.aionemu.chatserver.network.gs.GsConnectionFactoryImpl;
...
public class NettyServer
{
	...
	public NettyServer()
	{
		loginToClientPipeLineFactory = new LoginToClientPipeLineFactory(new ClientPacketHandler());
		initialize();
	}
	...
	public void initialize()
	{
		...
		final Channel loginToClientChannel = initChannel(loginToClientChannelFactory, Config.CHAT_ADDRESS, loginToClientPipeLineFactory);
		
		channelGroup.add(loginToClientChannel);
		
		final ServerCfg gs = new ServerCfg(Config.GAME_ADDRESS.getAddress().getHostAddress(), Config.GAME_ADDRESS.getPort(), "Gs Connections", new GsConnectionFactoryImpl());
