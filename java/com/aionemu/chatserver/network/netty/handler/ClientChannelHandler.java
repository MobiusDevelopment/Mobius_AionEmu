...
public class ClientChannelHandler extends AbstractChannelHandler
{
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception
	{
		...
		final AbstractClientPacket clientPacket = clientPacketHandler.handle((ChannelBuffer) e.getMessage(), this);
	...
	{
		final ChannelBuffer cb = ChannelBuffers.buffer(ByteOrder.LITTLE_ENDIAN, 2 * 8192);
