...
public class CM_CHANNEL_REQUEST extends AbstractClientPacket
{
	...
	protected void runImpl()
	{
		...
		final ChatClient chatClient = clientChannelHandler.getChatClient();
		final Channel channel = chatService.registerPlayerWithChannel(chatClient, channelIndex, channelIdentifier);
		if (channel != null)
		{
