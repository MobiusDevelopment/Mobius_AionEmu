...
public class CM_CHANNEL_MESSAGE extends AbstractClientPacket
{
	...
	{
		final Channel channel = ChatChannels.getChannelById(channelId);
		final Message message = new Message(channel, content, clientChannelHandler.getChatClient());
		...
		{
			final long endTime = (clientChannelHandler.getChatClient().getGagTime() - System.currentTimeMillis()) / 1000 / 60;
