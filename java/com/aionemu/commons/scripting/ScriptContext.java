...
public interface ScriptContext
{
	...
	/**
	 * Notifies all script classes that they must save their data and release resources to prevent memory leaks. It's done via static methods with {@link com.aionemu.commons.scripting.metadata.OnClassUnload} annotation
	 */
	void shutdown();
	...
	/**
	 * Adds child contexts to this context. If this context is initialized - chiled context will be initialized immideatly. In other case child context will be just added and initialized when {@link #init()} would be called. Duplicated child contexts are not allowed, in such case child will be
	 * ignored
	...
	/**
	 * Tests if this ScriptContext is equal to another ScriptContext. Comparation is done by comparing root files and parent contexts (if there is any parent)
