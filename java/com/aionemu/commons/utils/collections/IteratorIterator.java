 ...
 * <p/>
 * < pre> &lt;code&gt; Usage:&lt;br&gt; List&lt;List&lt;Integer&gt;&gt; someList = .... IteratorIterator&lt;Integer&gt; iterator = new IteratorIterator&lt;Integer&gt;(someList)
 * <p/>
 * OR:
 * <p/>
 * Map&lt;Integer, Set&lt;SomeClass&gt;&gt; mapOfSets = .... IteratorIterator&lt;SomeCLass&gt; iterator = new IteratorIterator&lt;SomeClass&gt;(mapsOfSets.values()); &lt;/code&gt;
 * </pre>
 * <p/>
 ...
 * <p/>
 * < pre> &lt;code&gt; Set&lt;Set&lt;Integer&gt;&gt; setOfSets = .... setOfSets.add(null); setOfSets.add(someSetOfIntegers); // Where someSetsOfIntegers is a set containing 1 and 2
 * <p/>
 * IteratorIterator&lt;Integer&gt; it = new IteratorIterator&lt;Integer&gt;(setOfSets); &lt;/code&gt;
 * </pre>
 * <p/>
...
public class IteratorIterator<V> implements Iterator<V>
{
	...
	public boolean hasNext()
	{
		...
		{
			final Iterable<V> iterable = firstLevelIterator.next();
