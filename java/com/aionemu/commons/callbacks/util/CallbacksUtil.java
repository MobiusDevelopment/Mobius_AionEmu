...
public class CallbacksUtil
{
	...
	public static boolean isAnnotationPresent(CtMethod method, Class<? extends java.lang.annotation.Annotation> annotation)
	{
		for (Object o : method.getMethodInfo().getAttributes())
		{
			...
			{
				final AnnotationsAttribute attribute = (AnnotationsAttribute) o;
	 ...
	 * <p/>
	 * < pre> {@link com.aionemu.commons.callbacks.CallbackPriority#DEFAULT_PRIORITY} - {@link com.aionemu.commons.callbacks.CallbackPriority#getPriority()}
	 * </pre>
	 * <p/>
	 * .<br>
	...
	public static int getCallbackPriority(Callback callback)
	{
		...
		{
			final CallbackPriority instancePriority = (CallbackPriority) callback;
	...
	{
		final int callbackPriority = CallbacksUtil.getCallbackPriority(callback);
		...
		if (!list.isEmpty())
		{
			...
			{
				final Callback c = list.get(i);
				
				final int cPrio = CallbacksUtil.getCallbackPriority(c);
