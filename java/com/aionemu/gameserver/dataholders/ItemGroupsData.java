...
public class ItemGroupsData
{
	...
	void afterUnmarshal(Unmarshaller u, Object parent)
	{
		...
		for (FoodType foodType : FoodType.values())
		{
			...
			if (food != null)
			{
				final FastSet<Integer> itemIds = FastSet.newInstance();
	...
	{
		return count + manastonesCommon.getItems().size() + manastonesRare.getItems().size() + manastonesLegend.getItems().size() + manastonesEpic.getItems().size() + foodCommon.getItems().size() + foodRare.getItems().size() + foodLegendary.getItems().size() + medicineCommon.getItems().size() + medicineRare.getItems().size() + medicineLegendary.getItems().size() + oresRare.getItems().size() + oresUnique.getItems().size() + oresLegendary.getItems().size() + oresEpic.getItems().size() + gatherCommon.getItems().size() + gatherRare.getItems().size() + gatherUnique.getItems().size() + gatherLegendary.getItems().size() + gatherEpic.getItems().size() + enchants.getItems().size() + boss.getItems().size();
	}
