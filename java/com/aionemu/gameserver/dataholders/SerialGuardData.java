...
public class SerialGuardData
{
	...
	@XmlTransient
	private final TIntObjectHashMap<GuardRankRestriction> templates = new TIntObjectHashMap<>();
	
	@XmlTransient
	private final TIntObjectHashMap<GuardTypeRestriction> templatesType = new TIntObjectHashMap<>();
