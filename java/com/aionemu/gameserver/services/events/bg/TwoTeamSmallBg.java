...
public class TwoTeamSmallBg extends Battleground
{
	...
	public TwoTeamSmallBg()
	{
		...
		final BattlegroundMap map1 = new BattlegroundMap(300030000);
		...
		super.maps.add(map1);
		// Dark Poeta.
		final BattlegroundMap map2 = new BattlegroundMap(300040000);
		...
		final BattlegroundMap map3 = new BattlegroundMap(300050000);
		...
		super.maps.add(map3);
		// Sulfur Tree Nest.
		final BattlegroundMap map4 = new BattlegroundMap(300060000);
		...
		final BattlegroundMap map5 = new BattlegroundMap(300070000);
		...
		super.maps.add(map5);
		// Left Wing Chamber.
		final BattlegroundMap map6 = new BattlegroundMap(300080000);
		...
		super.maps.add(map6);
		// Right Wing Chamber.
		final BattlegroundMap map7 = new BattlegroundMap(300090000);
		...
		super.maps.add(map7);
		// Steel Rake.
		final BattlegroundMap map8 = new BattlegroundMap(300100000);
		...
		super.maps.add(map8);
		// Baranath Dredgion.
		final BattlegroundMap map9 = new BattlegroundMap(300110000);
		...
		final BattlegroundMap map10 = new BattlegroundMap(300120000);
		...
		final BattlegroundMap map11 = new BattlegroundMap(300130000);
		...
		final BattlegroundMap map12 = new BattlegroundMap(300140000);
		...
		// Udas Temple.
		final BattlegroundMap map13 = new BattlegroundMap(300150000);
		...
		// Lower Udas Temple.
		final BattlegroundMap map14 = new BattlegroundMap(300160000);
		...
		// Beshmundir Temple.
		final BattlegroundMap map15 = new BattlegroundMap(300170000);
		...
		// Taloc's Hollow.
		final BattlegroundMap map16 = new BattlegroundMap(300190000);
		...
		// Haramel.
		final BattlegroundMap map17 = new BattlegroundMap(300200000);
		...
		// Chantra Dredgion.
		final BattlegroundMap map18 = new BattlegroundMap(300210000);
		...
		// Kromede Trial.
		final BattlegroundMap map19 = new BattlegroundMap(300230000);
		...
		// Aturam Sky Fortress.
		final BattlegroundMap map20 = new BattlegroundMap(300240000);
		...
		// Esoterrace.
		final BattlegroundMap map21 = new BattlegroundMap(300250000);
		...
		// Rentus Base.
		final BattlegroundMap map22 = new BattlegroundMap(300280000);
		...
		// Terath Dredgion.
		final BattlegroundMap map23 = new BattlegroundMap(300440000);
		...
		// Tiamat Stronghold.
		final BattlegroundMap map24 = new BattlegroundMap(300510000);
		...
		final BattlegroundMap map25 = new BattlegroundMap(300520000);
		...
		// Eternal Bastion.
		final BattlegroundMap map26 = new BattlegroundMap(300540000);
		...
		// Ophidan Bridge.
		final BattlegroundMap map27 = new BattlegroundMap(300590000);
		...
		// Raksang Ruins.
		final BattlegroundMap map28 = new BattlegroundMap(300610000);
		...
		final BattlegroundMap map29 = new BattlegroundMap(300620000);
		...
		final BattlegroundMap map30 = new BattlegroundMap(300630000);
		...
		// The Hexway.
		final BattlegroundMap map31 = new BattlegroundMap(300700000);
		...
		// Infinity Shard.
		final BattlegroundMap map32 = new BattlegroundMap(300800000);
		...
		// Danuar Reliquary.
		final BattlegroundMap map33 = new BattlegroundMap(301110000);
		...
		// Kamar Battlefield.
		final BattlegroundMap map34 = new BattlegroundMap(301120000);
		...
		// Sauro Supply Base.
		final BattlegroundMap map35 = new BattlegroundMap(301130000);
		...
		final BattlegroundMap map36 = new BattlegroundMap(301140000);
		...
		// Nightmare Circus.
		final BattlegroundMap map37 = new BattlegroundMap(301160000);
		...
		final BattlegroundMap map38 = new BattlegroundMap(301210000);
		...
		// Iron Wall Warfront.
		final BattlegroundMap map39 = new BattlegroundMap(301220000);
		...
		// Illuminary Obelisk.
		final BattlegroundMap map40 = new BattlegroundMap(301230000);
		...
		// Linkgate Foundry.
		final BattlegroundMap map41 = new BattlegroundMap(301270000);
		...
		// Idgel Dome.
		final BattlegroundMap map42 = new BattlegroundMap(301310000);
		...
		// Danuar Sanctuary.
		final BattlegroundMap map43 = new BattlegroundMap(301380000);
		...
		// Drakenspire Depths.
		final BattlegroundMap map44 = new BattlegroundMap(301390000);
		...
		final BattlegroundMap map45 = new BattlegroundMap(301400000);
		...
		// Stonespear Reach.
		final BattlegroundMap map46 = new BattlegroundMap(301500000);
		...
		// Sealed Argent Manor.
		final BattlegroundMap map47 = new BattlegroundMap(301510000);
		...
		final BattlegroundMap map48 = new BattlegroundMap(301540000);
		...
		// Cradle Of Eternity.
		final BattlegroundMap map49 = new BattlegroundMap(301550000);
		...
		final BattlegroundMap map50 = new BattlegroundMap(301550000);
		...
		final BattlegroundMap map51 = new BattlegroundMap(301610000);
		...
		final BattlegroundMap map52 = new BattlegroundMap(301610000);
		...
		// Drakenseer's Lair.
		final BattlegroundMap map53 = new BattlegroundMap(301620000);
		...
		final BattlegroundMap map54 = new BattlegroundMap(301630000);
		...
		final BattlegroundMap map55 = new BattlegroundMap(301640000);
		...
		// Fallen Poeta.
		final BattlegroundMap map56 = new BattlegroundMap(301660000);
		...
		// Ophidan Warpath.
		final BattlegroundMap map57 = new BattlegroundMap(301670000);
		...
		// Aether Mine.
		final BattlegroundMap map58 = new BattlegroundMap(301690000);
		...
		// Old Fire Temple.
		final BattlegroundMap map59 = new BattlegroundMap(302000000);
		...
		// Fissure Of Oblivion.
		final BattlegroundMap map60 = new BattlegroundMap(302100000);
		...
		// Karamatis A.
		final BattlegroundMap map61 = new BattlegroundMap(310010000);
		...
		// Aerdina.
		final BattlegroundMap map62 = new BattlegroundMap(310030000);
		...
		// Aetherogenetics Lab.
		final BattlegroundMap map63 = new BattlegroundMap(310050000);
		...
		final BattlegroundMap map64 = new BattlegroundMap(310080000);
		...
		// Indratu Fortress.
		final BattlegroundMap map65 = new BattlegroundMap(310090000);
		...
		// Azoturan Fortress.
		final BattlegroundMap map66 = new BattlegroundMap(310100000);
		...
		// Sky Temple Interior.
		final BattlegroundMap map67 = new BattlegroundMap(320050000);
		...
		// Space Of Destiny.
		final BattlegroundMap map68 = new BattlegroundMap(320070000);
		...
		// Fire Temple.
		final BattlegroundMap map69 = new BattlegroundMap(320100000);
		...
		final BattlegroundMap map70 = new BattlegroundMap(320110000);
		...
		// Padmarashka's Cave.
		final BattlegroundMap map71 = new BattlegroundMap(320150000);
		...
		// Transidium Annex.
		final BattlegroundMap map72 = new BattlegroundMap(400030000);
		...
		final BattlegroundMap map73 = new BattlegroundMap(600080000);
	...
	public void startMatch()
	{
			...
			for (PlayerGroup group : super.getGroups())
			{
				for (Player pl : group.getMembers())
				{
					if (!pl.isAfk())
					{
						...
						final SpawnPosition pos = getSpawnPositions().get(group.getBgIndex());
						performCdReset(pl);
						if (pos != null)
						{
		...
		super.setExpireTask(ThreadPoolManager.getInstance().schedule(() -> endTwoTeamMatch(true), getMatchLength() * 1000));
	...
	public boolean createTournament(List<List<Player>> teams)
	{
		...
		maxRounds = 5;
		description = "Your must defeat the opposing team. There is " + maxRounds + " rounds. The team with the most won round, win's !!!";
		matchLength = 165;
		startMatch();
		return true;
	}
	...
	private void addRoundWin(PlayerGroup group)
	{
		...
		final Integer result = roundResults.get(group.getBgIndex());
		if (result != null)
		{
	...
	void endTwoTeamMatch(boolean isDraw)
	{
		if (endCalled)
		{
			return;
		...
		final PlayerGroup roundWinner = getRoundWinner();
		if (roundWinner != null)
		{
			isDraw = false;
		}
