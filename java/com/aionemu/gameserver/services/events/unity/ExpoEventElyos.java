...
public class ExpoEventElyos
{
	...
	{
		CronService.getInstance().schedule(() -> startEvent(), BABI_EVENT_SCHEDULE_ELYOS);
	...
	public static void startEvent()
	{
		...
		World.getInstance().doOnAllPlayers(object -> PacketSendUtility.sendYellowMessageOnCenter(object, "Event, look for wild boar in the start location Sanctum quickly follow to take the prize!"));
		...
		final ActionObserver observer = new ActionObserver(ObserverType.ATTACKED)
		{
			...
			public void attacked(Creature creature)
			{
				if (creature instanceof Player)
				{
					...
					World.getInstance().doOnAllPlayers(object -> PacketSendUtility.sendYellowMessageOnCenter(object, player.getName() + "Menemukan babi hutan dan mendapatkan [item:%d]"));
				}
