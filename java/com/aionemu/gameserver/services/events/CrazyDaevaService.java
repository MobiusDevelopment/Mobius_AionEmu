...
public class CrazyDaevaService
{
	...
	{
		final int currentCrazyKillCount = winner.getCrazyKillCount();
		winner.setCrazyKillCount(currentCrazyKillCount + 1);
		final int newCrazyKillCount = currentCrazyKillCount + 1;
	...
	public static CrazyDaevaService getInstance()
	{
