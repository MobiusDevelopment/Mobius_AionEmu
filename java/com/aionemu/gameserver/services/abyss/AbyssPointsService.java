...
public class AbyssPointsService
{
	...
	static abstract public class AddAPGlobalCallback implements Callback
	{
		@Override
		...
		public CallbackResult afterCall(Object obj, Object[] args, Object methodResult)
		{
			...
			final VisibleObject creature = (VisibleObject) args[1];
			final int abyssPoints = (Integer) args[2];
	 ...
	 */
	@SuppressWarnings("rawtypes")
	static abstract public class AddGPGlobalCallback implements Callback
	{
		@Override
		public CallbackResult beforeCall(Object obj, Object[] args)
		{
		...
		public CallbackResult afterCall(Object obj, Object[] args, Object methodResult)
		{
			final Player player = (Player) args[0];
			final VisibleObject creature = (VisibleObject) args[1];
			final int gloryPoints = (Integer) args[2];
			if ((creature instanceof Player))
			{
