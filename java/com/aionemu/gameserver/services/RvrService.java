...
public class RvrService
{
	...
	public void startRvr(int id)
	{
		...
		ThreadPoolManager.getInstance().schedule(() -> stopRvr(id), duration * 3600 * 1000);
	}
	...
	public boolean LF6G1Spawn01Msg(int id)
	{
		switch (id)
		{
			case 3:
			{
				World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_LF6_G1_Spawn_01));
				return true;
			}
			default:
			{
	...
	public boolean LF6G1Spawn02Msg(int id)
	{
		switch (id)
		{
			case 3:
			{
				World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_LF6_G1_Spawn_02));
				return true;
			}
			default:
			{
	...
	public boolean LF6G1Spawn03Msg(int id)
	{
		switch (id)
		{
			case 3:
			{
				World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_LF6_G1_Spawn_03));
				return true;
			}
			default:
			{
	...
	public boolean DF6G1Spawn01Msg(int id)
	{
		switch (id)
		{
			case 4:
			{
				World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_DF6_G1_Spawn_01));
				return true;
			}
			default:
			{
	...
	public boolean DF6G1Spawn02Msg(int id)
	{
		switch (id)
		{
			case 4:
			{
				World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_DF6_G1_Spawn_02));
				return true;
			}
			default:
			{
	...
	public boolean DF6G1Spawn03Msg(int id)
	{
		switch (id)
		{
			case 4:
			{
				World.getInstance().doOnAllPlayers(player -> PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_DF6_G1_Spawn_03));
				return true;
			}
			default:
			{
