...
public class SuspiciousOphidanBridgeService
{
	...
	public void initSuspiciousOphidan()
	{
		if (AutoGroupConfig.OPHIDAN_WARPATH_ENABLED)
		{
			...
			CronService.getInstance().schedule(() -> startSuspiciousOphidanRegistration(), AutoGroupConfig.OPHIDAN_WARPATH_SCHEDULE_MIDNIGHT);
		}
	}
	...
	void startSuspiciousOphidanRegistration()
	{
