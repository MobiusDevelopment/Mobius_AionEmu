...
public class ItemSocketService
{
	...
	public static ManaStone addManaStone(Item item, int itemId)
	{
		...
		final ItemCategory manastoneCategory = DataManager.ITEM_DATA.getItemTemplate(itemId).getCategory();
		...
		final int start = manastoneCategory == ItemCategory.SPECIAL_MANASTONE ? 0 : specialSlotCount;
		final int end = manastoneCategory == ItemCategory.SPECIAL_MANASTONE ? specialSlotCount : manaStones.size();
		int nextSlot = start;
