...
import com.aionemu.gameserver.network.ls.serverpackets.SM_PTRANSFER_CONTROL;
...
public class PlayerTransferService
{
	...
	private final Map<Integer, TransferablePlayer> transfers = FastMap.newInstance();
	private final List<Integer> rsList = FastList.newInstance();
