...
public class Npc extends Creature
{
	...
	{
		if (getTribe() == TribeClass.NOFIGHT)
		{
			return false;
		}
	...
	public boolean isAggressiveTo(Creature creature)
	{
		...
		if (((getTribe() == TribeClass.XDRAKAN_DGUARD) && (creature.getTribe() == TribeClass.XDRAKAN_LGUARD)) || ((getTribe() == TribeClass.XDRAKAN_LGUARD) && (creature.getTribe() == TribeClass.XDRAKAN_DGUARD)))
		{
			return true;
		}
	...
	public boolean guardAgainst(Npc npc)
	{
		...
		if ((getTribe().isLightGuard() || ((getRace() == Race.ELYOS) && (getObjectTemplate().getNpcTemplateType() == NpcTemplateType.GUARD))) && DataManager.TRIBE_RELATIONS_DATA.isAggressiveRelation(npc.getTribe(), TribeClass.PC))
		{
			return true;
		}
		if ((getTribe().isDarkGuard() || ((getRace() == Race.ASMODIANS) && (getObjectTemplate().getNpcTemplateType() == NpcTemplateType.GUARD))) && DataManager.TRIBE_RELATIONS_DATA.isAggressiveRelation(npc.getTribe(), TribeClass.PC_DARK))
		{
			return true;
		}
		return false;
	...
	public boolean isRewardAP()
	{
		...
		else if ((getWorldType() == WorldType.BALAUREA) || (getWorldType() == WorldType.PANESTERRA) || isInInstance())
		{
