...
public class LandMarkReward extends InstanceReward<LandMarkPlayerReward>
{
	...
	{
		final Point3D a = new Point3D(263.45642f, 166.1216f, 79.430855f); // Blood War Room.
		final Point3D e = new Point3D(266.275f, 351.1437f, 79.44365f); // Steel War Room.
