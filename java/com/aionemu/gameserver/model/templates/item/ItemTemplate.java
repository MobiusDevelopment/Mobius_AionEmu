...
public class ItemTemplate extends VisibleObjectTemplate
{
	...
	private final ItemPurchableLimits purchableLimits = new ItemPurchableLimits();
	...
	{
		return (category == ItemCategory.MANASTONE) || (category == ItemCategory.SPECIAL_MANASTONE) || (category == ItemCategory.PRIMARY_MANASTONE);
	}
