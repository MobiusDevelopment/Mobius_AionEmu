...
public class EnchantItemAction extends AbstractItemAction
{
	...
	public boolean canAct(Player player, Item parentItem, Item targetItem)
	{
		...
		if ((targetItem.getEnchantLevel() == 15) && (targetItem.getItemTemplate().getArmorType() == ArmorType.WING))
		{
			PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_ENCHANT_ITEM_IT_CAN_NOT_BE_ENCHANTED_MORE_TIME(targetItem.getNameId()));
			return false;
		}
		...
		final int msID = parentItem.getItemTemplate().getTemplateId() / 1000000;
		final int tID = targetItem.getItemTemplate().getTemplateId() / 1000000;
		final int wID = targetItem.getItemTemplate().getTemplateId() / 1000000;
		if (((msID != 167) && (msID != 166)) || ((tID >= 120) && (wID != 187)))
		{
			return false;
		}
		if ((targetItem.canAmplification()) && parentItem.getItemTemplate().isAmplificationStone() && (targetItem.getEnchantLevel() == targetItem.getItemTemplate().getMaxEnchantLevel()) && !targetItem.isAmplified())
		{
