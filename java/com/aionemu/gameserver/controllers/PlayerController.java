...
public class PlayerController extends CreatureController<Player>
{
	...
	private final FastMap<Integer, VisibleObject> autoPortals = new FastMap<>();
	...
	public void onEnterZone(ZoneInstance zone)
	{
		...
		/**
		 * These instances portal are "spawn & reversed" to the opposite race. If a player enter in fews area, a portal will appear automatically. These portals are only 2 minute ingame before despawn. PS: Please, check "portal/AI2" for these portal.
		 */
		...
		if (player.getAccessLevel() == 0)
		{
			if (
			// Morheim.
			(zone.getAreaTemplate().getZoneName() == ZoneName.get("MORHEIM_SNOW_FIELD_220020000")) || (// Beluslan.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("KURNGALFBERG_220040000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("RED_MANE_CAVERN_220040000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("BELUSLAN_FORTRESS_220040000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("HOARFROST_SHELTER_220040000")) || (// Brusthonin.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("POLLUTED_WASTE_220050000")) || (// Gelkmaros.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("ANTAGOR_BATTLEFIELD_220070000")) || (// Enshar.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("DAWNBREAK_TEMPLE_220080000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("WHIRLPOOL_TEMPLE_220080000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("DRAGONREST_TEMPLE_220080000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("FATEBOUND_LEGION_OUTPOST_220080000")) || (// Norsvold.
			...
			// Eltnen.
			(zone.getAreaTemplate().getZoneName() == ZoneName.get("MANDURI_FOREST_210020000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("GOLDEN_BOUGH_GARRISON_210020000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("MYSTIC_SPRING_OF_AGAIRON_210020000")) || (// Heiron.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("HEIRONOPOLIS_210040000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("PATEMA_RUINS_210040000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("ARBOLUS_HAVEN_210040000")) || (// Inggison.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("CALMHEART_GROVE_210050000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("WILDHEART_GROVE_210050000")) || (// Theobomos.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("PORT_ANANGKE_210060000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("JOSNACKS_VIGIL_210060000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("CRIMSON_BARRENS_210060000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("OBSERVATORY_VILLAGE_210060000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("SOUTHERN_LATHERON_COAST_210060000")) || (// Cygnea.
			zone.getAreaTemplate().getZoneName() == ZoneName.get("AEQUIS_OUTPOST_210070000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("AEQUIS_HEADQUARTERS_210070000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("AEQUIS_ADVANCE_POST_210070000")) || (zone.getAreaTemplate().getZoneName() == ZoneName.get("AEQUIS_DETACHMENT_POST_210070000")) || (// Iluma.
	...
	public void onDie(Creature lastAttacker, boolean showPacket)
	{
		...
		if (EventsConfig.ENABLE_CRAZY)
		{
			if (((master instanceof Player)) && (master.getRace() != player.getRace()))
			{
				CrazyDaevaService.getInstance().crazyOnDie(player, master, true);
			}
		}
	...
	public void upgradePlayer()
	{
		...
		/**
		 * http://static.ncsoft.com/aion/store/PatchNotes/AION_Patch_Notes_061715.pdf Mentor status now cancels automatically as soon as the lowest level group member reaches level 51
		 */
	...
	/**
	 * After entering game player char is "blinking" which means that it's in under some protection, after making an action char stops blinking. - Starts protection active - Schedules task to end protection
	 */
