...
public final class FastMath
{
	 ...
	 * <p/>
	 * A good implementation found on the Java boards. note: a number is a power of two if and only if it is the smallest number with that number of significant bits. Therefore, if you subtract 1, you know that the new number will have fewer bits, so ANDing the original number with anything less
	 * than it will give 0.
	...
	/**
	 * Interpolate a spline between at least 4 control points following the Catmull-Rom equation. here is the interpolation matrix m = [ 0.0 1.0 0.0 0.0 ] [-T 0.0 T 0.0 ] [ 2T T-3 3-2T -T ] [-T 2-T T-2 T ] where T is the tension of the curve the result is a value between p1 and p2, t=0 for p1, t=1
	 * for p2
	 * @param u value from 0 to 1
	 * @param T The tension of the curve
	 * @param p0 control point 0
	...
	/**
	 * Fast Trig functions for x86. This forces the trig functiosn to stay within the safe area on the x86 processor (-45 degrees to +45 degrees) The results may be very slightly off from what the Math and StrictMath trig functions give due to rounding in the angle reduction but it will be very very
	 * close.
	 * <p/>
