...
public class Effect implements StatOwner
{
	...
	private final Map<Integer, EffectTemplate> successEffects = new FastMap<Integer, EffectTemplate>().shared();
	...
	/**
	 * Correct lifecycle of Effect - INITIALIZE - APPLY - START - END Do initialization with proper calculations
	 */
	public void initialize()
	{
		...
		if (successEffects.isEmpty())
		{
			...
			if (getSkillType() == SkillType.PHYSICAL)
			{
				...
				{
					final Player p = (Player) getEffector();
