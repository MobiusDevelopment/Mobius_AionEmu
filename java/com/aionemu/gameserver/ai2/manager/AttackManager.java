...
public class AttackManager
{
	...
	private static boolean checkGiveupDistance(NpcAI2 npcAI)
	{
		...
		{ // TODO: Check Client and use chase_user_by_trace value
			if (((npc.getGameStats().getLastAttackTimeDelta() > 20) && (npc.getGameStats().getLastAttackedTimeDelta() > 20)) || ((distanceToHome > (chaseHome / 2)) && (npc.getGameStats().getLastAttackedTimeDelta() > 2)))
			{
				return true;
			}
		}
