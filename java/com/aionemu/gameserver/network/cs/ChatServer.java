...
import com.aionemu.gameserver.network.cs.serverpackets.SM_CS_PLAYER_AUTH;
import com.aionemu.gameserver.network.cs.serverpackets.SM_CS_PLAYER_LOGOUT;
	...
	public ChatServerConnection connect()
	{
		...
		for (;;)
		{
			...
			try
			{
				...
				final CsPacketHandlerFactory csPacketHandlerFactory = new CsPacketHandlerFactory();
