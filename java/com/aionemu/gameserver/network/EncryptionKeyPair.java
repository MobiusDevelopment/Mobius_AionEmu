...
public class EncryptionKeyPair
{
	 ...
	 * Static xor key
	 */
	private static final byte[] staticKey = "nKO/WctQ0AVLbpzfBkS6NevDYT8ourG5CRlmdjyJ72aswx4EPq1UgZhFMXH?3iI9".getBytes();
	
	/**
	 * Second byte of client packet must be equal to this
	 */
	private static final byte staticClientPacketCode = 0x7D;
