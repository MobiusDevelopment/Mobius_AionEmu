...
import com.aionemu.gameserver.network.ls.serverpackets.SM_ACCOUNT_AUTH;
import com.aionemu.gameserver.network.ls.serverpackets.SM_ACCOUNT_DISCONNECTED;
import com.aionemu.gameserver.network.ls.serverpackets.SM_ACCOUNT_RECONNECT_KEY;
import com.aionemu.gameserver.network.ls.serverpackets.SM_BAN;
import com.aionemu.gameserver.network.ls.serverpackets.SM_LS_CONTROL;
...
public class LoginServer
{
	...
	public void accountAuthenticationResponse(int accountId, String accountName, boolean result, AccountTime accountTime, byte accessLevel, byte membership, long toll)
	{
		...
		final Account account = AccountService.getAccount(accountId, accountName, accountTime, accessLevel, membership, toll);
