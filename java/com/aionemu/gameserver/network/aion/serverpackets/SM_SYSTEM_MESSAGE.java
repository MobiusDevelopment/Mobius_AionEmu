...
public class SM_SYSTEM_MESSAGE extends AionServerPacket
{
	...
	/**
	 * /CreateChannel [ChannelName] [OptionalPassword]: Creates a private channel. /JoinChannel [ChannelName] [Password]: Enters an existing private channel. Password required if one was set. /LeaveChannel [ChannelNumber]: Leaves a private channel. /ChannelMemberInfo [ChannelNumber]: Shows who's in
	 * a channel. /ChannelInfo [ChannelNumber]: Shows information for a channel you are in. /ChannelBanInfo [ChannelNumber]: Shows who is banned from a channel. /BanFromChannel [ChannelNumber] [CharacterName]: The channel owner can permanently remove a character from the channel. /UnbanFromChannel
	 * [ChannelNumber] [CharacterName]: The channel owner can reinstate a banned character's access to a channel. /ChangeChannelLeader [ChannelNumber] [CharacterName]: The channel owner makes another character the channel owner. /ChangeChannelPassword [ChannelNumber] [Password]: The channel owner
	 * can change the password. /ChannelHelp: Shows the commands available for channels.
	 */
	...
	public static SM_SYSTEM_MESSAGE STR_MSG_UNEQUIP_RANKITEM_TIMER_10M(int value0)
	{
		return new SM_SYSTEM_MESSAGE(1401327, new DescriptionId(value0));
	}
	
	public static SM_SYSTEM_MESSAGE STR_MSG_UNEQUIP_RANKITEM_TIMER_1M(int value0)
	{
		return new SM_SYSTEM_MESSAGE(1401328, new DescriptionId(value0));
	}
	
	public static SM_SYSTEM_MESSAGE STR_MSG_UNEQUIP_RANKITEM(int value0)
	{
	...
	{
		return new SM_SYSTEM_MESSAGE(1402579, new Object[]
		{
			nameId,
			nameId2
		});
	...
	public static SM_SYSTEM_MESSAGE STR_MSG_EXCEED_NO_TARGET_ITEM(DescriptionId descriptionId)
	{
