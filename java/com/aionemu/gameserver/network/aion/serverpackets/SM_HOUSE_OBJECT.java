...
public class SM_HOUSE_OBJECT extends AionServerPacket
{
	...
	protected void writeImpl(AionConnection con)
	{
		...
		final House house = houseObject.getOwnerHouse();
		final int templateId = houseObject.getObjectTemplate().getTemplateId();
		...
		writeD(0);
		final byte typeId = houseObject.getObjectTemplate().getTypeId();
		writeC(typeId);
		switch (typeId)
		{
			case 1:
