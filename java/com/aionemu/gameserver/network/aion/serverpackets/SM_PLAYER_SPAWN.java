...
public class SM_PLAYER_SPAWN extends AionServerPacket
{
	...
	protected void writeImpl(AionConnection con)
	{
		...
		else if (((player.getWorldId() == 300510000) || (player.getWorldId() == 300520000) || (player.getWorldId() == 300600000) || (player.getWorldId() == 300480000) || (player.getWorldId() == 301110000) || (player.getWorldId() == 301140000) || (player.getWorldId() == 300800000) || (player.getWorldId() == 300590000) || (player.getWorldId() == 301130000) || (player.getWorldId() == 300540000) || (// [Legion]
																																																																																																				// Kysis-Miren-Krotan
																																																																																																				// Barracks
																																																																																																				// 4.5
		player.getWorldId() == 301230000) || (player.getWorldId() == 301240000) || (player.getWorldId() == 301250000) || (player.getWorldId() == 301260000) || (player.getWorldId() == 301270000) || (player.getWorldId() == 301280000) || (player.getWorldId() == 301290000) || (player.getWorldId() == 301300000) || (// [Infernal]
																																																																														// Illuminary
																																																																														// Obelisk
																																																																														// &
																																																																														// [Infernal]
																																																																														...
																																																																														// Reliquary
																																																																														// 4.7
		player.getWorldId() == 301360000) || (player.getWorldId() == 301370000) || (// [Occupied] Rentus Base & [Anguished] Dragon Lord's Refuge & Raksang Ruins & Danuar Sanctuary 4.8
		player.getWorldId() == 300610000) || (player.getWorldId() == 300620000) || (player.getWorldId() == 300630000) || (player.getWorldId() == 301380000) || (// Drakenspire Depths 4.8 & Sealed Argent Manor 4.9.1
		player.getWorldId() == 301390000) || (player.getWorldId() == 301510000) || (// Archives Of Eternity 5.0 & Cradle Of Eternity 5.1
		player.getWorldId() == 301540000) || (player.getWorldId() == 301550000) || (// Adma's Fall 5.0 & Theobomos Test Chamber 5.0
		player.getWorldId() == 301600000) || (player.getWorldId() == 301610000) || (// Drakenseer's Lair 5.0 & Ashunatal Dredgion 5.1
		player.getWorldId() == 301620000) || (player.getWorldId() == 301650000) || (// Fallen Poeta 5.1 & Fissure Of Oblivion 5.1
