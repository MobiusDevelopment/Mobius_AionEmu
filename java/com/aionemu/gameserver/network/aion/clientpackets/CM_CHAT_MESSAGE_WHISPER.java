...
public class CM_CHAT_MESSAGE_WHISPER extends AionClientPacket
{
	...
	protected void runImpl()
	{
		...
		final String formatname = Util.convertName(name);
		final Player sender = getConnection().getActivePlayer();
		final Player receiver = World.getInstance().findPlayer(formatname);
