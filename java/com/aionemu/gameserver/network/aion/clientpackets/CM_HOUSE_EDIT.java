...
public class CM_HOUSE_EDIT extends AionClientPacket
{
	...
	protected void runImpl()
	{
		...
		else if (action == HousingAction.ADD_ITEM)
		{
			...
			{
				final HouseDecoration decor = new HouseDecoration(IDFactory.getInstance().nextId(), decorateAction.getTemplateId());
			...
			else
			{
				...
				final HouseObject<?> obj = HouseObjectFactory.createNew(house, template);
