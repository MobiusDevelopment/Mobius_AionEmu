...
/**
 * This blob entry is sent with ALL items. (unless partial blob is constructed, ie: sending equip slot only) It is the first and only block for non-equipable items, and the last blob for EquipableItems
 * @author -Nemesiss-
 * @modified Rolandas
 */
